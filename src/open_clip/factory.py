...
def get_tokenizer(
    ...
    **kwargs,
    ...
    # ------------------------- Custom text encoder logic ------------------------- #

    # This is here to support the custom CinemaNet text encoder. The results of that
    # experiment led to the conclusion that we will probably never use this code path
    # again but this code chunk is being left here anyways
